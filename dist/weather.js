...
},{"./Component":34}],24:[function(require,module,exports) {
"use strict";
...
var LocationSearch = function (_Component) {
    ...
    function LocationSearch(props) {
        ...
        _this.recent.innerHTML = '<button class="btns__btn">Recent</button>';
        _this.favorites = document.createElement('div');
        _this.favorites.classList.add('favorites');
        _this.favorites.innerHTML = '<button class="btns__btn">Favorites</button>';
        ...
        _this.citiesList = document.createElement('div');
        _this.citiesList.classList.add('btns-wrapper__cities-list');
        _this.citiesList.addEventListener('click', _this.onClickCitiesList.bind(_this));
    ...
    _createClass(LocationSearch, [{
        ...
        key: 'onClickCitiesList',
        value: function onClickCitiesList(e) {
            e.preventDefault();
...
},{"../Facepalm":32,"../utils/api.js":24}],19:[function(require,module,exports) {
'use strict';
...
},{"../Facepalm":32}],20:[function(require,module,exports) {
'use strict';
...
},{"../Facepalm":32}],21:[function(require,module,exports) {
'use strict';
...
var Buttons = function (_Component) {
    ...
    function Buttons(props) {
        ...
        _this.favorites.classList.add('btns__btn');
...
},{"../Facepalm":32}],22:[function(require,module,exports) {
'use strict';
...
},{"../Facepalm":32}],23:[function(require,module,exports) {
'use strict';
...
},{"../Facepalm":32}],14:[function(require,module,exports) {
'use strict';
    ...
    _createClass(App, [{
        ...
        value: function onSubmit(city) {
            ...
            (0, _api.getWeather)(city).then(function (data) {
                _this2.updateState(data, city, 'today');
            }).catch(function (err) {
        ...
        key: 'updateRecent',
        value: function updateRecent(city, data) {
            if (city) {
        ...
        value: function updateFavourites(btn) {
            ...
            var recentArr = JSON.parse(recent);
            var lastCity = recentArr[recentArr.length - 1];
            var citiesArr = [];
            if (btn == 'Add to favorites') {
                if (favorite) {
                    this.state.isFav = true;
                ...
                citiesArr = JSON.parse(favorite);
                citiesArr.forEach(function (item, index) {
                    if (item.city == _this3.state.city) {
                        citiesArr.splice(index, 1);
        ...
        value: function checkFavorite() {
            ...
            if (citiesArr) {
                citiesArr = JSON.parse(citiesArr);
                citiesArr.forEach(function (item, index) {
                    if (item.city == _this4.state.city) {
...
exports.default = App;
},{"./Facepalm":32,"./components/locationSearch":18,"./components/todayForecast":19,"./components/fourDaysForecast":20,"./components/buttons":21,"./components/hourlyForecast":22,"./components/tenDays":23,"./utils/api":24}],5:[function(require,module,exports) {
"use strict";
...
},{"./src/App":14}],50:[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '33173' + '/');
...
//# sourceMappingURL=/dist/weather.map